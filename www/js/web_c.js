...
var moduleOverrides = {};  // 暂存的 overwrite
var key;
...
var err = Module["printErr"] ||
  (typeof console !== "undefined" ? console.warn.bind(console) :
    typeof printErr !== "undefined" ? printErr : out);
...
function integrateWasmJS() {
  var wasmTextFile = "../out/web_c.wast";
  var wasmBinaryFile = "../out/web_c.wasm";
  var asmjsCodeFile = "../out/web_c.temp.asm.js";
  ...
  function doNativeWasm(global, env, providedBuffer) {
    ...
    function receiveInstantiatedSource(output) {
      console.warn('webassembly module: ', output);
    ...
    // 向 wasm 中注册 js 方法
    info.env._callJs = function (val) {
      console.log('call js: ' + val);
    }
    info.env.jsHellow = function() {
...
// var _comic = (Module["_comic"] = function() {
//   return Module["asm"]["_comic"].apply(null, arguments);
// });
